...
<head>
    ...
    <title>404</title>
    <link rel="stylesheet" type="text/css" href="/static/404/css/normalize.css" /><!--CSS RESET-->
    <link rel="stylesheet" type="text/css" href="/static/404/css/htmleaf-demo.css"><!--演示页面样式，使用时可以不引用-->
